...
export default function LoginPage() {
  ...
  const handleMicrosoftLogin = () => {
    window.location.href = `${import.meta.env.VITE_API_URL || 'http://localhost:3000'}/api/auth/microsoft`;
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-xl max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Email Copilot</h1>
        ...
        <div className="space-y-4">
          ...
          >
            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.5 0h-9v9.5h9V0zm10 0h-9v9.5h9V0zm-10 10.5h-9V20h9v-9.5zm10 0h-9V20h9v-9.5z" />
            </svg>
